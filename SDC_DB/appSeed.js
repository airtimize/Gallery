...
pool.connect((err, client, done) => {
  ...
  myClient = client;
  const insertImgInfo ="copy images(listing_id, ImageID, ImageUrl, Caption, Verified) from" + "'" + path.join(__dirname, "/no_Image_ID.csv")  + "'" + "DELIMITER ',' CSV HEADER;" // this used the file without image_id
